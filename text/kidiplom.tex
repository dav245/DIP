...
Vue, Svelte a SolidJS. Součástí práce je jednoduchá aplikace, představující poštovního klienta, vytvořená v~každém frameworku
pro demonstartivní účely.}

\annotation[english]{The goal of this thesis is to compare reactive data approach of JavaScript frameworks Vue, Svelte and SolidJS.
...
\thanks{Mnohorát děkuji panu RNDr. Martinu Trnečkovi, Ph.D. za vedení a investovaný čas. }
...
\begin{thebibliography}{9}
  ...
  \bibitem{jsx} JSX. Dostupný z: \url{https://www.typescriptlang.org/docs/handbook/jsx.html}
